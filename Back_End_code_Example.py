...
df1=spark.read.option("inferschema",True).option("header",True).csv("dbfs:/mnt/input/data.csv")
...
df2.write.save("/mnt/replication/data_request/"+current_time_stamp)

# COMMAND ----------

dbutils.fs.ls("/mnt/replication/data_request")
